...
export default function About() {
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('./image/about.jpg')" }}>
      <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/50 to-black/60" />
      <Section id="about" title="Nuestra Historia" bgColor="bg-rose-1/10">
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-10 text-left">
            <div className="bg-white/30 p-8 rounded-3xl">
              <h3 className="text-2xl text-white font-semibold mb-6">Nuestra Filosofía</h3>
            ...
            <div className="bg-white/30 p-8 rounded-3xl">
              <h3 className="text-2xl text-white font-semibold mb-6">Nuestros Valores</h3>
              <div className="grid grid-cols-2 gap-8 text-center text-white text-lg font-medium">
      ...
      <Section title="Nuestro Equipo" bgColor="bg-rose-1/10">
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            { name: "Lorena Bravo", role: "Fundadora & Estilista Senior", image: "./team/lorena.jpg" },
            ...
            <div key={i} className="text-center">
              ...
              <p className="text-rose-600 font-medium mt-1">{member.role}</p>
            </div>
          ))}
        </div>
      </Section>
